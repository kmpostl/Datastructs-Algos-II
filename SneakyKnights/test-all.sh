...
if [ $NUM_TEST_CASES -ne 9 ]; then
	...
	echo "================================================================"
	echo ""
	echo "  TestCase06 through TestCase09 are skipped by default, since"
	echo "  their input files might be too large for you to transfer to"
	echo "  Eustis. If you are testing on your own system, you can force"
	echo "  this script to run those test cases by typing:"
	echo ""
