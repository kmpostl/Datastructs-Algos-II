...
public class SkipList<AnyType extends Comparable<AnyType>>
{
	...
	private void growSkipList()
	{
		...
		// Height map stores the most recent nodes for every possible height. This should be no longer needed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Used when i thought i needed to flip every node
		...
		// for (int i = defaultHeight; i <= head.height(); i++)
		// 	heightMap.put(i, current);

		//should redo this to while current != null
		...
		while (current != null)
		{
			...
			{
				//Node<AnyType> oldNode = heightMap.get(current.height());
